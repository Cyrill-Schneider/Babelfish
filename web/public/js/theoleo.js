...
var currentENV;
var nodeURL;
var googleAgent = 'THEOLEO'; // Set to 'THEO', 'HERMILIO' or 'THEOLEO'
...
if (location.hostname === "localhost" || location.hostname === "127.0.0.1") {
	...
	(googleAgent!=="THEOLEO") ?	nodeURL='https://theo-staging.herokuapp.com' : nodeURL='https://theoleo-staging.herokuapp.com';
} else {
	// FIXME 4 TheoLeo
	currentENV='PROD';
	// Assuming production, connect to node.de on Heroku PRODUCTION
...
const criticalErrorMsg="Oops! Theo kann leider nicht auf dein Mikrofon zugreifen.<P>Hast du...<BR>... der App den Zugriff aufs Mikrofon erlaubt?<BR>... den Mikrofonzugriff in deinem Browser aktiviert?<P>Bitte lade die Seite im Anschluss neu und versuche es noch einmal.<P>Viel Erfolg!<P> "
